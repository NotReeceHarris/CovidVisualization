...
def confirmed(_id):
    return render_template('iframe/confirmed.html', data=json.load(open("summary.json")), _id=_id)

@app.route('/iframe/recovered', defaults={'_id': None})
@app.route('/iframe/recovered/<string:_id>')
def recovered(_id):
    return render_template('iframe/recovered.html', data=json.load(open("summary.json")), _id=_id)

@app.route('/iframe/deaths', defaults={'_id': None})
@app.route('/iframe/deaths/<string:_id>')
def deaths(_id):
    return render_template('iframe/deaths.html', data=json.load(open("summary.json")), _id=_id)
